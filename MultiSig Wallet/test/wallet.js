...
contract('Wallet', (accounts) => {
  ...
  it('should be approved correctly',async ()=>{
    await wallet.createTransfer(100,accounts[5],{from: accounts[0]})
  ...
  it ('should not appove transfer if not owner', async()=>{
    await wallet.createTransfer(100, accounts[6], {from: accounts[0]});
    await expectRevert(
  ...
  it.only('should NOT approve transfer is transfer is already sent', async () => {
  await wallet.createTransfer(100, accounts[6], {from: accounts[0]});
  await wallet.approveTransfer(0, {from: accounts[0]});
  await expectRevert(
